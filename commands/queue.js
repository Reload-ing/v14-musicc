...
try {
    ...
    if (!queue.tracks[0]) return interaction.reply({ content: lang.msg63, ephemeral: true }).catch(e => { })
    ...
    .setDescription(`${lang.msg65}: \`${queue.current.title}\`
    ${current.map(data =>
    ...
    .setFooter({ text: `Developed by Reloading` })
